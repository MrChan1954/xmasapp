...
test("the authorization migration explicitly enables RLS on every application table", () => {
  ...
  // Q2 added 041-043 on top; Q3 added 044 and 045; Q5 added 046. What this
  ...
  // has changed.
  assert.equal(migrationFiles.at(-7), wishlistMigrationName);
  assert.equal(migrationFiles.at(-8), areaAuthMigrationName);
